...
class SelectedView: ObservableObject{
    ...
    init(){
        ...
        let businessTab: [TabViewItem] = [
            ...
            TabViewItem(UIHostingController(rootView: ProfileView(business: Business(database: Business.Database(name: "Gelinho Gourmet do Tutu", email: "danilo.lira01@gmail.com", phone: "+5581992656003", imgURL: "https://cdn.discordapp.com/attachments/788903633268768839/800473255445266452/duduzin.png", location: "Recife, PE", description: "Dudu - Dindin - Geladinho - Sacolé\nO nome não importa, o que importa é o sabor! e nisso a gente se garante :)\nDudu do Bom!\nO seu sorvete no saquinho, o dudu gourmet mais delicioso da região.", instagramURL: "https://www.instagram.com/danilo_lira01", facebookURL: "https://www.facebook.com/Lanilo.Dira01", category: .food, promotionalText: "Sacolés dos melhores sabores", coverURL: "https://cdn.discordapp.com/attachments/788903633268768839/800473234558418951/duduzincapa.png", id: "0101010101")), isActive: .constant(false))),name: "Perfil")
        ]
